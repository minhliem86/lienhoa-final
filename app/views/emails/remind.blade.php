			...
			<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
				<tr>
					<td align="center" valign="top" id="bodyCell">
						...
						-->
						<table  border="0" cellpadding="0" cellspacing="0" width="500" id="emailHeader">
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:15px;text-align:center;">LienhoaFashion</h1>
																		
																		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Khách hàng <b>{{$data->fullname}}</b> vừa gửi yêu cầu đến LienhoaFashion. Vui lòng kiểm tra trong <a href="http://www.lienhoafashion.net/lienhoafashionadmin" target="_blank" style="text-decoration:#991212;color:#828282;"><span style="color:#fff;">Admin CP Panel</a></span></div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
						...
						<table bgcolor="#E1E1E1" border="0" cellpadding="0" cellspacing="0" width="500" id="emailFooter">
							...
							<tr>
								<td align="center" valign="top">
									<!-- CENTERING TABLE // -->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#0e70b2">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer">
																...
																<tr>
																	<td valign="top" >
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#fff;text-align:center;line-height:120%;">
																			<div>Copyright &#169; 2015 <a href="http://www.lienhoafashion.net" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#fff;">Lienhoafashion</span></a>. All&nbsp;rights&nbsp;reserved.</div>
